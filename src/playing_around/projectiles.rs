...
impl Environment {
    ...
    pub fn run_sim(mut self, mut color: Color, fade_color: bool) -> io::Result<()> {
...
pub fn putting_together_chapter2() {
    ...
    env.run_sim(Color::new(0.3, 0.05, 0.1), true)
        .expect("failed to write canvas to file");
}
